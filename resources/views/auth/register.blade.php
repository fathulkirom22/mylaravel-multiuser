                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="date-of-birth" type="date" class="form-control" name="date_of_birth" value="{{old('date_of_birth')}}" required>
                        ...
                        <div class="form-group{{ $errors->has('no_hp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="no-hp" type="text" class="form-control" name="no_hp" value="{{old('no_hp')}}" required>
                                @if ($errors->has('no_hp'))
                                  <span class="help-block">
